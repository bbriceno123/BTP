...
export declare class FioriLanguage implements Language<{
    ...
    visitorKeys: {
        namespace: ("name" | "type" | "contentRange" | "range" | "nameRange" | "alias" | "aliasRange")[];
        target: ("name" | "type" | "range" | "nameRange" | "terms" | "termsRange")[];
        element: ("name" | "type" | "namespace" | "content" | "attributes" | "contentRange" | "range" | "nameRange" | "namespaceAlias")[];
        text: ("type" | "text" | "range" | "fragmentRanges" | "multilineType")[];
        "annotation-file": ("type" | "namespace" | "uri" | "targets" | "contentRange" | "references" | "range")[];
